            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4>Jenis Barang Yang Tersedia</h4>
                </div>
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="badge badge-success">Minuman</div>
                            </td>
                            <td class="align-justify">
                                <a href="/update_barang" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
                                <a href="#" class="btn btn-icon btn-danger"><i class="fas fa-trash"></i></a>
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tr>
                            ...
                            <td class="align-justify">
                              <a href="/kategori" class="btn btn-icon btn-primary">Lihat</a>
                            </td>
                          </tr>
                          <tr>
                            <td class="p-0 text-center">
