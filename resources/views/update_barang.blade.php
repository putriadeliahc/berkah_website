            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                ...
                <div class="card-body">
                        <form class="row g-3">
                            <div class="col-md-6">
                              <label for="UpdateData" class="form-label">Nama Barang</label>
                              <input type="text" class="form-control" id="UpdateData">
                            </div>
                            <div class="col-md-6">
                              <label for="UpdateHarga" class="form-label">Harga</label>
                              <input type="text" class="form-control" id="UpdateHarga">
                            </div>
                            <div class="col-12">
                              <label for="UpdateJenis" class="form-label">Jenis Barang</label>
                              <select class="form-select" aria-label="Default select example">
                                <option selected>pilih jenis barang</option>
                                <option value="1">Snack</option>
                                <option value="2">Rokok</option>
                                <option value="3">Sabun</option>
                              </select>
                            </div>
                            <div class="col-12">
                              <label for="inputTanggal" class="form-label">Tanggal Masuk</label>
                              <input type="date" class="form-control" id="UpdateTanggal">
                            </div>
                            <div class="col-12">
