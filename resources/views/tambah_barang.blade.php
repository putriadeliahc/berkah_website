                ...
                <div class="card-body">
                        <form class="row g-3">
                            <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" id="inputBarang" placeholder="Masukkan Nama Barang">
                            </div>
                            <div class="col-md-6">
                              <label for="inputHarga" class="form-label">Harga</label>
                              <input type="text" class="form-control" id="inputHarga" placeholder="Inputkan Harga">
                            </div>
                            <div class="col-12">
